 ...
 * @version 12/20/2013
 */
public class ActionsMsg extends AbstractNSenseMsg {
	...
	public ActionsMsg(byte hopCount, SequenceNumber sequenceNr, int radius,
			VectorN position, VectorN positionDimensions, int actionSize) {
		super(hopCount, sequenceNr, radius, position, positionDimensions,
				MSG_TYPE.ACTION_MSG);
