 ...
 * @version 12/20/2013
 */
public abstract class AbstractNSenseMsg implements Message {
	 ...
	 */
	public AbstractNSenseMsg(byte hopCount, SequenceNumber sequenceNr,
			int radius, VectorN position, VectorN positionDimensions,
			MSG_TYPE msgType) {
	 ...
	 * 
	 * @return the position as {@link VectorN}
	 */
	...
	public boolean equals(Object obj) {
		if (obj instanceof AbstractNSenseMsg) {
			AbstractNSenseMsg o = (AbstractNSenseMsg) obj;
