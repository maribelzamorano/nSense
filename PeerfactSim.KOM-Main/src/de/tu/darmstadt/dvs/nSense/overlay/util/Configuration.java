...
public class Configuration {
	...
	public static IPositionDistributionNDim POSITION_DISTRIBUTION = null;

	public static IMoveModelNDim MOVE_MODEL = null;
	...
	public static void setProperties(String file) {
		...
		try {
			...
			stream.close();
			DIMENSION = getPropertiesInt(properties, "dimensions",
					DIMENSION);
			if (DIMENSION == 0) {
				log.fatal("The value for DIMENSION is 0. It is a bad value");
			}
	...
	public static void setPositionDistribution(
			IPositionDistributionNDim positionDistribution) {
		POSITION_DISTRIBUTION = positionDistribution;
	}

	public static void setMoveModel(IMoveModelNDim moveModel) {
