...
public class RandomPointOfInterest implements IMoveModel {
	...
	public RandomPointOfInterest(int moveSpeedLimit, int worldDimensionX,
		...
		this.RandomPOI = new int[8][2];
		// for (int i = 0; i < 4; i++) {
		// RandomGenerator r = Simulator.getRandom();
		this.RandomPOI[0][0] = 200;// r.nextInt(worldDimensionX);
		this.RandomPOI[0][1] = 450;// r.nextInt(worldDimensionY);
		this.RandomPOI[1][0] = 1010;
		this.RandomPOI[1][1] = 347;
		this.RandomPOI[2][0] = 27;
		this.RandomPOI[2][1] = 57;
		this.RandomPOI[3][0] = 769;
		this.RandomPOI[3][1] = 567;
		this.RandomPOI[4][0] = 400;// r.nextInt(worldDimensionX);
		this.RandomPOI[4][1] = 650;// r.nextInt(worldDimensionY);
		this.RandomPOI[5][0] = 810;
		this.RandomPOI[5][1] = 547;
		this.RandomPOI[6][0] = 227;
		this.RandomPOI[6][1] = 257;
		this.RandomPOI[7][0] = 969;
		this.RandomPOI[7][1] = 767;
